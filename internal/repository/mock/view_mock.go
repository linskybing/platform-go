...
// Source: internal/repository/view.go
...
func (m *MockViewRepo) GetAllProjectGroupViews() ([]view.ProjectGroupView, error) {
	m.ctrl.T.Helper()
...
func (mr *MockViewRepoMockRecorder) GetUserRoleInGroup(uid, gid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
