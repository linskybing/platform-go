...
type Storage struct {
	...
	OwnerID        string         `gorm:"type:uuid;not null;index;references:resource_owners(id)"` // FK to Supertype
	...
	AffinityConfig datatypes.JSON `gorm:"type:jsonb;not null;default:'{}'"` // PSS Restricted strategy
