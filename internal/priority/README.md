...
Implements priority-based resource allocation where interactive workloads have higher priority than batch jobs. When resource contention occurs, lower-priority batch jobs are preempted to free resources for higher-priority workloads.
...
2. High-priority workload requires resources
...
7. Allow high-priority workload to start

## Priority Levels

- Interactive (Pods): Priority 1000
