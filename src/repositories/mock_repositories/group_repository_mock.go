...
// Source: ./repositories/group_repository.go
...
func (m *MockGroupRepo) GetGroupByID(id uint) (models.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockGroupRepo) UpdateGroup(group *models.Group) error {
	m.ctrl.T.Helper()
